...
class handDetector():
    ...
    def findPosition(self, img, handNo=0, draw=True):
        ...
        if self.results.multi_hand_landmarks:
            ...
            # print(self.results.multi_hand_landmarks[handNo])
    ...
    def fingersUp(self):
        ...
        # Thumb
        # print(self.tipIds[0])
        # print("1",self.lmList[self.tipIds[0]][1])
        # print("2",self.lmList[self.tipIds[0] - 1])[1])
        # print(self.lmList)
        ...
        # Fingers
        for id in range(1, 5):
            # print("1",self.lmList[self.tipIds[id]][2])
            # print("2",self.lmList[self.tipIds[id] - 2][2])
